...
| 19 | 🔵 | `ai:skill_version` required on every file | omit | `ai:skill_version: 7.16.1` |
| 20 | 🔵 | `ai:engine` required on every file | omit | `ai:engine: claude-sonnet-4-6` |
...
- [ ] `ai:skill_version: 7.16.1` · `ai:engine: claude-sonnet-4-6` present
