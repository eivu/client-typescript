...
version: 7.16.4-runtime
description: Condensed runtime reference for generating .eivu.yml files. Rules 7, 12, 17, 19, 22, 24, 27 enforced by post-processor — model should follow conventions but need not verify.
---

# EIVU Metadata Runtime v7.16.4
...
4.0 = Strong positive, minimal criticism                              → Masterwork tag (⚙️ added by post-processor)
...
- [ ] 2-space indent · no tabs · no null · pipe on multi-line descriptions
- [ ] One key per metadata_list item · no deprecated top-level `rating`
- [ ] ⚙️ Rules 7, 12, 17, 19, 22, 24, 27 enforced by post-processor — follow conventions but do not spend time verifying

### Name (Comics Only) 📗

> **Skip for audio and video.**

- [ ] Separator ` - ` (space-dash-space) · S## before v##/E##
