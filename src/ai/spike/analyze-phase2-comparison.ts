 ...
 *
 * Usage:
 *   npx tsx src/ai/spike/analyze-phase2-comparison.ts
 */
...
function buildArtifacts(): string[] {
  return [
    ...
    '- HTML explorer: `tmp/phase2-comparison-explorer.html` (run `node src/ai/spike/build-explorer.mjs tmp/phase2-comparison.json tmp/phase2-comparison-explorer.html`)',
    '- Pipeline definitions: `src/ai/pipelines/`',
    '- Spike variants: `src/ai/spike/variants/phase2-opus-4-7.ts` · `src/ai/spike/variants/phase2-sonnet-non-comics.ts`',
    '',
  ]
}
